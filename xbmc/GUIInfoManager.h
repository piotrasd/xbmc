...
#define LISTITEM_ENDTIME2           (LISTITEM_START + 146)
#define LISTITEM_NEXT_TITLE2        (LISTITEM_START + 147)
#define LISTITEM_NEXT_TITLE3        (LISTITEM_START + 148)
#define LISTITEM_NEXT_STARTTIME2    (LISTITEM_START + 149)
#define LISTITEM_NEXT_STARTTIME3    (LISTITEM_START + 150)
#define LISTITEM_NEXT_ENDTIME2      (LISTITEM_START + 151)
#define LISTITEM_NEXT_ENDTIME3      (LISTITEM_START + 152)
